...
invece delegato a una componente ``buisiness logic''. Il committente
...
\subsection{Diagramma per il caso d'uso di riconoscimento}
...
sistema per quanto riguarda il caso d'uso ``effettua riconoscimento'', si noti la ripartizione e la differenziazione di quattro principali
