...
Avendo deciso che la business logic del nostro sistema si basa su una rete
neurale per effettuare la computer vision implementata dalla libreria \mrcnn, cioè una
...
Il dataset ,sotto forma di albero di directory, risiede all'interno di google drive, servizio compatibile con colab.
...
annotazioni per le immagini utilizzate come istanze di training:\\ \url{http://www.robots.ox.ac.uk/~vgg/software/via/}.
